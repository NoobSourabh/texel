...
const School = () => {
    return (
        <section className='sec-1'>
            <img className='sec-1-img' src='https://res.cloudinary.com/dswwp9dju/image/upload/v1736325164/image-12_dyseh5.svg' />
            <img className='sec-1-img-mob' src='https://res.cloudinary.com/dswwp9dju/image/upload/v1736501574/image-37_bn9y1u.svg' />
            ...
            <Para />
            <p className='sec-1-para text-center pb-[15vh] tracking-wider'>Join us in our journey to help <strong>boost your school success</strong> and showing the true potential of every single child. <strong>With Texel in charge, the future of learning is bright, promising and brilliantly simple in concept.</strong></p>
        </section>
    )
}
