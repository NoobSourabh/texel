            ...
            <div className="ladder-background-image ">
                <div className='inner-lst-container pt-8'>
                    <div className='lst-flex'>
                        ...
                        <div className="w-[1214px] h-11 text-center text-[#252b42] text-[32px] font-bold font-arimo italic  leading-[43.52px] pb-[29px]">“ Quality comes without your permission “</div>                        {/* <img className='hidden md:block' src='https://res.cloudinary.com/dswwp9dju/image/upload/v1736437192/image-22_qllmxs.svg' /> */}
                ...
                <div className='lst-lower-flex'>
                    ...
                    <div className="w-[400px]  md:w-[948px]  text-[#252b42] text-[32px] font-bold font-arimo italic  leading-[43.52px]">“Join us in our mission to cultivate a future where education is a collaborative adventure, and together, let’s illuminate the path to academic excellence, one child at a time.“</div>
                </div>
