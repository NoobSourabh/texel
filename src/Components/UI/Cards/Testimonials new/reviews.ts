const originaltestimonial = [
    {
        ...
        role: "Parent",
        testimonialText: "Texel has made our lives so much easier. As a busy parent, staying on top of my child's schoolwork was stressful. Now, I get instant updates on everything. We're more connected and I have more information about my child’s education.",
        userName: "Ananya R."
    },
    {
...
export const testimonial = Array.from({ length: 3 }, () => originaltestimonial).flat();
